...
#OAR -n random_regular_n50_k5_t9
...
#OAR -O server_output/random_regular_n50_k5_t9.stdout
#OAR -E server_output/random_regular_n50_k5_t9.stderr

source /etc/profile.d/modules.sh                # Shell initialization to use module
make run INPUTFILE=quantas/topologies/random_regular_n50_k5_t9.json