...
#OAR -O server_output/erdos_renyi_n50_k5_t7.stdout
#OAR -E server_output/erdos_renyi_n50_k5_t7.stderr

source /etc/profile.d/modules.sh                # Shell initialization to use module
make run INPUTFILE=quantas/topologies/erdos_renyi_n50_k5_t7.json