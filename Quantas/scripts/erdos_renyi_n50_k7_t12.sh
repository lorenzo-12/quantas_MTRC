...
#OAR -O server_output/erdos_renyi_n50_k7_t12.stdout
#OAR -E server_output/erdos_renyi_n50_k7_t12.stderr

source /etc/profile.d/modules.sh                # Shell initialization to use module
make run INPUTFILE=quantas/topologies/erdos_renyi_n50_k7_t12.json