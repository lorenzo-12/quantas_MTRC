...
#OAR -n random_regular_n50_k7_t8
...
#OAR -O server_output/random_regular_n50_k7_t8.stdout
#OAR -E server_output/random_regular_n50_k7_t8.stderr

source /etc/profile.d/modules.sh                # Shell initialization to use module
make run INPUTFILE=quantas/topologies/random_regular_n50_k7_t8.json