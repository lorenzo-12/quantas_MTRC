...
#OAR -O server_output/edge_remover_n50_k7_t12.stdout
#OAR -E server_output/edge_remover_n50_k7_t12.stderr

source /etc/profile.d/modules.sh                # Shell initialization to use module
make run INPUTFILE=quantas/topologies/edge_remover_n50_k7_t12.json