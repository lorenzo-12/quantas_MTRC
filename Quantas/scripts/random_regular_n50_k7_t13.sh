...
#OAR -n random_regular_n50_k7_t13
...
#OAR -O server_output/random_regular_n50_k7_t13.stdout
#OAR -E server_output/random_regular_n50_k7_t13.stderr

source /etc/profile.d/modules.sh                # Shell initialization to use module
make run INPUTFILE=quantas/topologies/random_regular_n50_k7_t13.json