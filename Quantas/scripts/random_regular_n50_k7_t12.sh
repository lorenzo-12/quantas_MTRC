...
#OAR -n random_regular_n50_k7_t12
...
#OAR -O server_output/random_regular_n50_k7_t12.stdout
#OAR -E server_output/random_regular_n50_k7_t12.stderr

source /etc/profile.d/modules.sh                # Shell initialization to use module
make run INPUTFILE=quantas/topologies/random_regular_n50_k7_t12.json